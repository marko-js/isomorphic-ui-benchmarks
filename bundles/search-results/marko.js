...
var marko_template = module.exports = vdom.t(), marko_component = {
    ...
    }, marko_registerComponent = indexBrowser.rc, marko_componentType = marko_registerComponent('/isomorphic-ui-benchmarks$1.0.0/benchmarks/search-results/marko/components/app-search-results-item/index.marko', function () {
        return module.exports;
    }), marko_classAttr = helpers.ca, marko_attrs0 = { 'class': 'lvpic pic img left' }, marko_attrs1 = { 'class': 'price' }, marko_attrs2 = { 'class': 'lvpicinner full-width picW' }, marko_createElement = helpers.e, marko_const = helpers.const, marko_const_nextId = marko_const('b5f87b'), marko_node0 = marko_createElement('DIV', { 'class': 'purchased' }, 1, 0, { c: marko_const_nextId() }).t('Purchased!'), marko_attrs3 = {
        type: 'button',
        'class': 'buy-now'
    };
function render(input, out, __component, component, state) {
    var data = input;
    out.be('DIV', {
        'class': marko_classAttr(['search-results-item']),
        style: helperStyleAttr({ backgroundColor: state.purchased ? '#f1c40f' : '' }),
        id: __component.id
    }, null, 4);
    out.e('H2', null, 1).t(input.title);
    out.e('DIV', marko_attrs0, 1).e('DIV', marko_attrs2, 1).e('A', {
        href: '/buy/' + input.id,
        'class': 'img imgWr2'
    }, 1).e('IMG', {
        src: input.image,
    ...
    out.e('SPAN', marko_attrs1, 1).t(input.price);
    if (state.purchased) {
        out.n(marko_node0);
    } else {
        out.e('BUTTON', marko_attrs3, 1, 0, { onclick: __component.d('handleBuyButtonClick') }).t('Buy now!');
    }
    out.ee();
}
...
var marko_template = module.exports = vdom.t(),
    marko_createElement = helpers.e,
    marko_const = helpers.const,
    marko_const_nextId = marko_const("75ab7e"),
    marko_node0 = marko_createElement("FOOTER", {
        id: "glbfooter",
        role: "contentinfo",
        "class": "gh-w"
      }, 4, 0, {
                        ...
                        .e("UL", {
                          ...
                          .e("LI", {
                            ...
                            .e("A", {
                              ...
                              .e("B", {
                                  "class": "flde gf-if gspr"
                                }, 0)
                              .t("Germany")
                          .e("LI", {
                              "class": "gf-f-li1 gf-f-li-top"
                            }, 1)
                            .e("A", {
                          ...
                          .e("LI", {
                            ...
                            .e("A", {
                              ...
                              .e("B", {
                                  "class": "flmy gf-if gspr"
                                }, 0)
                              .t("Malaysia")
                          .e("LI", {
                              "class": "gf-f-li2 gf-f-li-top"
                            }, 1)
                            .e("A", {
                          ...
                          .e("LI", {
                            ...
                            .e("A", {
                              ...
                              .e("B", {
                                  "class": "flch gf-if gspr"
                                }, 0)
                              .t("Switzerland")
                          .e("LI", {
                              "class": "gf-f-li3 gf-f-li-top"
                            }, 1)
                            .e("A", {
          ...
          .e("TBODY", null, 2)
            ...
            .e("TR", {
              ...
              .e("TD", {
                ...
                .t("Copyright © 1995-2016 eBay Inc. All Rights Reserved. ")
                .e("A", {
...
var marko_template = module.exports = vdom.t(), marko_component = {
    ...
    }, marko_registerComponent = indexBrowser.rc, marko_componentType = marko_registerComponent('/isomorphic-ui-benchmarks$1.0.0/benchmarks/search-results/marko/components/app/index.marko', function () {
        return module.exports;
    }), marko_forEach = helpers.f, marko_loadTag = helpers.t, app_search_results_item_tag = marko_loadTag(index$10), app_footer_tag = marko_loadTag(index$12);
function render(input, out, __component, component, state) {
    var data = input;
    out.be('DIV', {
    ...
    marko_forEach(input.items, function (item) {
        app_search_results_item_tag(item, out);
    });
    out.ee();
    app_footer_tag({}, out);
    out.ee();
...
window.addBench('marko', function(el, getNextSearchResults) {
    ...
    var component = index.renderSync(getNextSearchResults())
        .appendTo(el)
        .getComponent();
