var app = (function () {
    ...
    var App = class extends Component$1 {
      constructor(props) {
        super(props);
        this.state = {
      ...
      renderColor(color, i) {
        ...
        return createVNode$1(1, "li", className, createTextVNode$1(color.name), 2, {
          "style": style,
          "onClick": linkEvent$1({
            component: this,
            colorIndex: i
      ...
      renderColors(colors) {
        if (colors.length) {
          return createVNode$1(1, "ul", null, colors.map((color, i) => {
            return this.renderColor(color, i);
          }), 4);
        } else {
          return createVNode$1(1, "div", null, "No colors!", 16);
        }
      }
      ...
      render() {
        ...
        return createVNode$1(1, "div", "colors", [createVNode$1(1, "h1", null, "Choose your favorite color:", 16), createVNode$1(1, "div", "colors", this.renderColors(colors), 2), createVNode$1(1, "div", null, [createTextVNode$1("You chose:"), createVNode$1(1, "div", "chosen-color", createTextVNode$1(selectedColor.name), 2)], 4)], 4);
      }

    };

    var hydrate$1 = index_esm$1.hydrate;
    var render$1 = index_esm.render;
    ...
    if (window.colors) {
      hydrate$1(createComponentVNode$1(2, App, {
    ...
    window.addBench("inferno", function (el, colors) {
      ...
      render$1(createComponentVNode$1(2, App, {
        "colors": colors,
        "onMount": onMount
      }), el);
