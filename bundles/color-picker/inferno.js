...
function handleColorClick(_ref) {
...
var App = function (_Component) {
    ...
    _class.prototype.renderColor = function renderColor(color, i) {
        ...
        return createVNode$1(2, 'li', className, color.name, {
            'style': style,
            'onClick': linkEvent$1({ component: this, colorIndex: i }, handleColorClick)
        });
    };

    _class.prototype.renderColors = function renderColors(colors) {
        var _this2 = this;

        if (colors.length) {
            return createVNode$1(2, 'ul', null, colors.map(function (color, i) {
                return _this2.renderColor(color, i);
            }));
        } else {
            return createVNode$1(2, 'div', null, 'No colors!');
        }
    };
    ...
    _class.prototype.render = function render() {
        ...
        return createVNode$1(2, 'div', 'colors', [createVNode$1(2, 'h1', null, 'Choose your favorite color:'), createVNode$1(2, 'div', 'colors', this.renderColors(colors)), createVNode$1(2, 'div', null, ['You chose:', createVNode$1(2, 'div', 'chosen-color', selectedColor.name)])]);
    };
...
if (window.colors) {
    render(createVNode(16, App, null, null, {
