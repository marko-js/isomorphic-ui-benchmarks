var app = (function () {
	...
	*/
	...
	var _ref = react.createElement("h1", null, "Choose your favorite color:");

	var _ref2 = react.createElement("div", null, "No colors!");
	...
	function App({
	  ...
	  return react.createElement("div", {
	    ...
	    className: "colors"
	  }, colors.length ? react.createElement("ul", null, colors.map((color, i) => react.createElement("li", {
	  ...
	  }, color.name))) : _ref2), react.createElement("div", null, "You chose:", react.createElement("div", {
	...
	if (window.colors) {
	  reactDom.hydrate(react.createElement(App_1, {
	...
	window.addBench("react", function (el, colors) {
	  ...
	  reactDom.render(react.createElement(App_1, {
	    colors: colors,
	    onMount: _set => setSelectedColorIndex = _set
	  }), el);
	  return done => {
