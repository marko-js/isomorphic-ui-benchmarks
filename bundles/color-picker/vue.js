...
var App = {
    ...
    methods: {
        handleColorClick: function handleColorClick(colorIndex) {
    ...
    render: function render(h) {
        ...
        function renderColor(color, i) {
            ...
            return h(
                'li',
                { 'class': ["color", selectedColorIndex === i && "selected"], key: i, style: style, on: {
                        'click': handleColorClick.bind(self, i)
                    }
                },
                [color.name]
            );
    ...
    var app = new Vue({
        ...
        render: function render(h) {
            return h(
                App,
                {
                    attrs: { colors: colors, handleMount: onMount }
                },
                []
            );
        }
