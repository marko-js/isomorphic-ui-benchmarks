$_mod.def("/marko$4.2.0/morphdom/index", function(require, exports, module, __filename, __dirname) { 'use strict';
var defaultDoc = typeof document == 'undefined' ? undefined : document;
var specialElHandlers = require('/marko$4.2.0/morphdom/specialElHandlers'/*'./specialElHandlers'*/);

var morphAttrs = require('/marko$4.2.0/runtime/vdom/VElement'/*'../runtime/vdom/VElement'*/).G;
        ...
        if (nodeName !== 'TEXTAREA') {
            ...
            outer: while (curToNodeChild) {
                ...
                while (curFromNodeChild) {
                    ...
                    if (curFromNodeType === curToNodeChild.x) {
