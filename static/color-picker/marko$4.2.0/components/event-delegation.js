$_mod.def("/marko$4.2.0/components/event-delegation", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.2.0/components/util-browser'/*'./util'*/);
var runtimeId = componentsUtil.O;
var componentLookup = componentsUtil.P;
var getMarkoPropsFromEl = componentsUtil.Q;
...
function delegateEvent(node, target, event) {
    ...
    if (extraArgs != null) {
        if (typeof extraArgs === 'number') {
            extraArgs = targetComponent.R[extraArgs];
...
function attachBubbleEventListeners(doc) {
    ...
    require('/marko$4.2.0/components/bubble'/*'./bubble'*/).forEach(function addBubbleHandler(eventType) {
...
exports.S = noop;
exports.T = noop;
exports.U = delegateEvent;
exports.V = getEventFromEl;

exports.W = function(doc) {
