$_mod.def("/marko$4.2.0/components/registry-browser", function(require, exports, module, __filename, __dirname) { var loadComponent = require('/marko$4.2.0/components/loadComponent-dynamic'/*'./loadComponent'*/);
var defineComponent = require('/marko$4.2.0/components/defineComponent'/*'./defineComponent'*/);
...
function getComponentClass(typeName) {
    ...
    if (!ComponentClass._I) {
        ComponentClass = defineComponent(ComponentClass, ComponentClass.renderer);
    }

    // Make the component "type" accessible on each component instance
    ComponentClass.prototype._q = typeName;
