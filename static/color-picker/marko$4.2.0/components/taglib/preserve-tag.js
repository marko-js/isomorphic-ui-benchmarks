$_mod.def("/marko$4.2.0/components/taglib/preserve-tag", function(require, exports, module, __filename, __dirname) { var ComponentsContext = require('/marko$4.2.0/components/ComponentsContext'/*'../ComponentsContext'*/);
var getElementById = require('/marko$4.2.0/components/util-browser'/*'../util'*/)._o;
...
module.exports = function render(input, out) {
    ...
    if (global.$w !== undefined) {
        ...
        if (condition !== false) {
            var existingEl = getElementById(out._H, id);
            if (existingEl) {
                ...
                componentsContext.aF(id, bodyOnly);
                return;
            }
        }
    }
